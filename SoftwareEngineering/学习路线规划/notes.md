...
在传统理论上，软件工程自 1968 年至今已经累积了大量的研究成果，并基于实际生产环境进行了大量的项目实践，借由学术界和产业界的共同努力，软件工程最终发展成为了一门独立的专业。根据 ACM 与 IEEE Computer Society 联合修定的 SWEBOK（即Software Engineering Body of Knowledge 的英文缩写）建议，软件工程这一领域的核心知识包括：
...
但大型机构都存在官僚主义的问题，效率低下，随着时间的推移它们往往都会离人们的实际需求越来越远，就像是基督教的大教堂，高高在上，定期发布信息，内容庞杂而臃肿。对于以创意为主导的中小软件开发是毫无帮助。
