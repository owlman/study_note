...
在这篇学习笔记中，笔者将记录一些在学习 Node.js 环境时所编写的代码示例与学习心得。为此，我会在`ProgrammingLanguage/JavaScript`目录下创建一个名为的`nodejs`目录，并在该目录下设置以下两个子目录：
...
这一部分笔记将致力于记录一个"线上书店"项目的实现过程，这是对于 Node.js 学习的成果验收。
