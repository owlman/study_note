...
这一里程碑主要聚焦的是*快速学习能力*。在如今的软件开发活动中，对特定功能的开发都是通过引入特定的第三方扩展库与框架来完成的。但是，我们可以选择的第三方扩展库与框架不仅琳琅满目，选择众多，而且通常新陈代谢极为快速。这意味着，即使我们在这里介绍了当前最为流行的扩展库与框架，很有可能只需要几个月的时间，开发者们就已经有了更好的选择。所以授之以鱼不如授之以渔，我们真正需要知道的是如何找到并阅读特定第三方扩展库或框架本身提供的官方文档。因此，达成这一里程碑的标准我们能快速根据自己的项目需求来引入相关的扩展库或框架并能掌握它们的使用方法。
