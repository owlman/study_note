...
在编程方法论（Programming Methodology）这一课题下，我们主要关注的是两个既彼此独立又相互关联的问题：如何设计程序？如何构建程序？而这两个问题本质上都在探讨如何针对编程的目标进行模块化设计。在这里，所谓的模块化（Modularity），指的是我们按照某个既定的规则将要实现的程序划分成若干个相对独立的部分来实现，以便达到分而治之的效果。
