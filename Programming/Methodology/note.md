...
在累积了一定的、使用 Java 语言的项目经验之后，读者就可以搭配顶级工程师们分享的经验来提炼对面向对象编程方法论的领悟了。在这一阶段，我会推荐读者参考《设计模式》这本书。该书的作者从实际的工业实践中提炼出了进行面向对象程序设计时常用的 23 个设计模式。

![《设计模式》](img/1-4.jpg)

需要注意的是，通常提到所谓的设计模式时，人们很容易有意无意地把模式误认知为模版，然后在各种工作实践中进行各种生搬硬套的操作，但实际上它们只不过是一些设计套路的组合而已，是可以变化的，根据实际情况重新组合的，甚至在某些情况下还可以作为设计反例存在。总而言之，书中的这些模式很好地总结了面向对象方法论中最有价值的经验, 并且将其用简洁可复用的形式表达了出来。
