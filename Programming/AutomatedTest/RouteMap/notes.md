...
基本上，只要很好地掌握了 Selenium 和 Robot framekwork 这两个框架，那么无论是主流的、基于 Web 界面的自动化测试，还是面向其他 UI 的自动化测试，我们都能够获得一定的心得体会与实践经验，并且在日后的自我学习中举一反三，让自己在就业市场中占有一席地位。

2.2 Appium学习方法

Appium不仅支持安卓还支持iOS，所以在这里，我们应该选择学习Appium最能满足市场的需要。
